...
import pandas as pd
'''
#! Order of the rooms for rows and columns
Upper E
Lower E
Reactor
Security
...
adjacency_matrix_impostor = [
    [0, 7, inf, 5.5, 9, 7, inf, inf, inf, inf, inf, inf, inf, inf, inf],
    [7,0, inf, 5.5, inf, inf, inf, inf, inf,inf, 10, 8.5,inf,inf,inf],
    [inf,inf,0, 4,inf,inf,inf,inf,inf,inf,inf,inf,inf,inf,inf],
    [5.5, 5.5, 4,0,inf,inf,inf,inf,inf,inf,inf,inf,inf,inf,inf],
    [9,inf,inf,inf,0, 7, 5.5,inf,inf,inf, 8.5,inf,inf,inf,inf],
    [7,inf,inf,inf, 7,0,inf,inf,inf,inf,inf,inf,inf,inf,inf],
    [inf,inf,inf,inf, 5.5,inf,0, 4.5,inf, 10,inf,inf,inf,inf, 6.5],
    [inf,inf,inf,inf,inf,inf, 4.5,0, 7, 9.5,inf,inf,inf,inf, 6],
    [inf,inf,inf,inf,inf,inf,inf, 7,0,inf,inf,inf,inf,inf, 5],
    [inf,inf,inf,inf,inf,inf, 10, 9.5,inf,0, 6,inf,inf, 4, 3.5],
    [inf, 10,inf,inf, 8.5,inf,inf,inf,inf, 6,0, 7.5, 7, 6,inf],
    [inf, 8.5,inf,inf,inf,inf,inf,inf,inf,inf, 7.5,0,inf,inf,inf],
    [inf,inf,inf,inf,inf,inf,inf,inf,inf,inf, 7,inf,0,inf,inf],
    [inf,inf,inf,inf,inf,inf,inf,inf,inf, 4, 6,inf,inf,0,inf],
    [inf,inf,inf,inf,inf,inf, 6.5, 6, 5, 3.5,inf,inf,inf,inf,0],
]

Room_list_impostor = ["Upper E",
"Lower E",
"Reactor",
"Security",
"Cafeteria",
